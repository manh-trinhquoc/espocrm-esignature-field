...
```
vendor/bin/phpunit tests/unit/Espo/Modules/EsignatureField
```
...
```
vendor/bin/phpunit tests/integration/Espo/Modules/EsignatureField
```
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/EsignatureField`
* `site/tests/integration/Espo/Modules/EsignatureField`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/EsignatureField/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/EsignatureField/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/esignature-field/lib/init.js"
        ]
    }
    ```
